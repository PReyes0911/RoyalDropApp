package com.example.royaldropapp.Adapter;
...
import com.example.royaldropapp.PersonalOrderActivity;
import com.example.royaldropapp.R;
...
public class MyPersonalHistoryAdapter extends RecyclerView.Adapter<MyPersonalHistoryAdapter.MyPersonalViewHolder> {
    ...
    @NonNull
    @Override
    public MyPersonalViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        return new MyPersonalViewHolder(LayoutInflater.from(context)
                .inflate(R.layout.layout_personal_order_item,parent,false));

    }

    @Override
    public void onBindViewHolder(@NonNull MyPersonalViewHolder holder, int position) {
